...
Instructions:
-Initialize a new git repo. in a local project folder, and create a JavaScript file to contain your code. (Complete)
-Commit frequently! Every time something works, you should commit it. aRemember, you can always go back to a previous commit if something breaks.
